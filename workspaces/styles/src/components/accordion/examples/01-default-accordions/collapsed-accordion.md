...
classes: ['.v-accordion', 'details.v-accordion', '.v-accordion-heading', 'summary.v-accordion-heading', '.v-accordion-toggle-icon', '.v-accordion-toggle-icon-open', '.v-accordion-toggle-icon-closed', '.v-accordion-panel']
tags: ['docs']
order: 0
---
