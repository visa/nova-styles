 ...
 *
 -->
---
title: Informational banner with link
description: Nova informational banner with icon, description, and link. 
classes: ['.v-banner', '.v-message', '.v-message-info', '.v-banner.v-message.v-message-info', '.v-message-icon', '.v-message-content', '.v-link']
tags: ['docs']
order: 3
---
