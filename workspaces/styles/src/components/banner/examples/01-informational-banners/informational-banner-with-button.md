...
description: Nova informational banner with icon, description, and button. 
classes: ['.v-banner', '.v-message', '.v-message-info', '.v-banner.v-message.v-message-info', '.v-message-icon', '.v-message-content', '.v-button.v-button-secondary']
tags: ['docs']
order: 4
---
