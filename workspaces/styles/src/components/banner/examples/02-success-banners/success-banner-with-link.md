 ...
 *
 -->
---
title: Success banner with link
description: Nova success banner with icon, description, and link. 
classes: ['.v-banner', '.v-message', '.v-message-success', '.v-banner.v-message.v-message-success', '.v-message-icon', '.v-message-content', '.v-link']
tags: ['docs']
order: 9
---
