...
description: Nova success banner with icon, title, description, and close button. 
classes: ['.v-banner', '.v-message', '.v-message-success', '.v-banner.v-message.v-message-success', '.v-message-icon', '.v-message-content', '.v-typography-body-2-bold']
tags: ['docs']
order: 8
---
