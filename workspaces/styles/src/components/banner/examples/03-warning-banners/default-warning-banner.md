...
description: Nova warning banner with icon, description, and close button. 
classes: ['.v-banner', '.v-message', '.v-message-warning', '.v-banner.v-message.v-message-warning', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 13
---
