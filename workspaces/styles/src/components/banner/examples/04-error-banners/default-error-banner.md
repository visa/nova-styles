 ...
 *
 -->
---
title: Default error banner
description: Nova error banner with icon, description, and close button. 
classes: ['.v-banner', '.v-message', '.v-message-error', '.v-banner.v-message.v-message-error', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 19
---
