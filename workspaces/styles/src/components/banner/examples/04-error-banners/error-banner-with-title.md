...
description: Nova error banner with icon, title, description, and close button. 
classes: ['.v-banner', '.v-message', '.v-message-error', '.v-banner.v-message.v-message-error', '.v-message-icon', '.v-message-content', '.v-typography-body-2-bold']
tags: ['docs']
order: 20
---
