...
description: Nova error banner with icon, description, and button. 
classes: ['.v-banner', '.v-message', '.v-message-error', '.v-banner.v-message.v-message-error', '.v-message-icon', '.v-message-content', '.v-button.v-button-secondary']
tags: ['docs']
order: 22
---
