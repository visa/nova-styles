 ...
 *
 -->
---
title: Warning flag without close icon button
description: Warning flag without close icon button.
classes: ['.v-flag', '.v-message.v-message-warning', '.v-message-icon']
tags: ['docs']
order: 17
---
