 ...
 *
 -->
---
title: Informational flag without close icon button
description: Informational flag without close icon button.
classes: ['.v-flag', '.v-message', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 5
---

<div class="v-message v-flag">
