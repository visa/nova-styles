 ...
 *
 -->
---
title: Success flag with button
description: Success flag with icon, title, description, and close button.
classes: ['.v-flag', '.v-message.v-message-success', '.v-message-icon', '.v-message-content', '.v-button.v-button-secondary']
tags: []
order: 10
---
