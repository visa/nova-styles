 ...
 *
 -->
---
title: Success flag with title 
description: Nova success flag with icon, title, description, and close button.
classes: ['.v-flag', '.v-message.v-message-success', '.v-message-icon', '.v-message-content', '.v-typography-body-2-bold']
tags: []
order: 8
---

<div class="v-message v-message-success v-flag">
