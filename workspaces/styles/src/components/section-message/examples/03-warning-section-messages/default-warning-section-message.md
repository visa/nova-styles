 ...
 *
 -->
---
title: Default warning section message
description: Nova warning section message with icon, description, and close button. 
classes: ['.v-section', '.v-message', '.v-message-warning', '.v-section.v-message.v-message-warning', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 13
---
