 ...
 *
 -->
---
title: Default subtle section message
description: Nova subtle section message with icon, title, description, and close button. 
classes: ['.v-section', '.v-message', '.v-message-subtle', '.v-message.v-section', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 25
---
