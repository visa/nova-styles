...
description: Nova informational section message with icon, title, description, and close button. 
classes: ['.v-section', '.v-message', '.v-message-info', '.v-message.v-section', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 1
---
