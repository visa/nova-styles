 ...
 *
 -->
---
title: Informational section message with title
description: Nova informational section message with icon, title, description, and link. 
classes: ['.v-section', '.v-message', '.v-message-info', '.v-message.v-section', '.v-message-icon', '.v-message-content', '.v-typography-body-2-bold']
tags: ['docs']
order: 2
---
