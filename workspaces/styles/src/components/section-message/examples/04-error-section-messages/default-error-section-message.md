 ...
 *
 -->
---
title: Default error section message
description: Nova error section message with icon, description, and close button. 
classes: ['.v-section', '.v-message', '.v-message-error', '.v-section.v-message.v-message-error', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 19
---
