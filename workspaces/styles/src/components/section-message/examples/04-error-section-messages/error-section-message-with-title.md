 ...
 *
 -->
---
title: Error section message with title
description: error section message with icon, title, description, and close button. 
classes: ['.v-section', '.v-message', '.v-message-error', '.v-section.v-message.v-message-error', '.v-message-icon', '.v-message-content', '.v-typography-body-2-bold']
tags: ['docs']
order: 20
---
