 ...
 *
 -->
---
title: Default success section message
description: Nova success section message with icon, description, and close button. 
classes: ['.v-section', '.v-message', '.v-message-success', '.v-section.v-message.v-message-success', '.v-message-icon', '.v-message-content']
tags: ['docs']
order: 7
---
