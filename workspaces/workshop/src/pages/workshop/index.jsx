  ...
  return (
    <>
      <Helmet>
        ...
        />
        <title>
          {capitalCase(item)} {capitalCase(type)} | Styles | Visa Product Design
          System
        </title>
      </Helmet>
      <SkipToContent />
      <div
        className={[
          "w-app",
          globalState.sideNavOpen ? "w-app-side-nav" : "",
          type === "components" || type === "abstracts" || type === "base"
            ? "w-app-drawer"
            : "",
        ]
          .join(" ")
      ...
      >
        ...
        <Menu selectedType={type} selectedItem={item} />
        {type === "themes" ? (
