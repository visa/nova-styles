...
const Home = () => {
  ...
  const [contentDirection] = useStickyState(
    "horizontal",
    "w-content-direction",
  );
  ...
  const getTocObject = (name) => {
    const found = toc
      .map((x) =>
        noCase(x.name) === noCase(name)
          ? x
          : x.children && x.children.length > 0
            ? x.children.map((y) =>
                noCase(y.name) === noCase(name) ? y : null,
              )
            : null,
      )
      .flat()
        ...
        >
          <div className="w-area" ref={contentRef}>
            <div className="w-home-area">
              ...
              <br />
              <p>
                Themable CSS library for the Visa Product Design System that
                includes accessible html templates for static rendering and
                styles for web components and app develpment.
              </p>
              <br />
              <br />
              <div className="w-section-installation v-flex v-flex-row v-flex-nowrap v-gap-4">
                <div className="v-surface w-home-content">
                  ...
                  <h3
                    className="v-typography-headline-3"
                    id="download"
                    ref={getTocRef("download")}
                  >
                    Download
                  </h3>
                  <br />
                  You can download the latest or any available version through
                  artifactory:&nbsp;
                  <Link
                  ...
                  <br />
                  <p>
                    Once you've imported your styles, just copy and paste the
                    component examples on this site into your application.
                  </p>
                  <br />
                  <h3
                    className="v-typography-headline-3"
                  ...
                  <br />
                  <p>
                    Rendering the components on your app is as easy as copying
                    and pasting the code examples. All native elements include
                    support for{" "}
                  ...
                  <br />
                  <p>
                    Some more complex components would require Javascript
                    interaction to give the component full functionality, like{" "}
                    <Link route="components/accordion">accordion</Link> and{" "}
                    <Link route="components/section-message">
                      section message
                    </Link>
                    , where the consuming library or app would need to include
                    some extra javascript interactions to guarantee usability
                    and accessibility.
                  </p>
                  <br />
                  <h3
                  ...
                  <br />
                  <p>
                    Our library provides certain utility classes that let you
                    shape your pages, arrange components, and provide font
                    styles. For more info and examples, see{" "}
                    <Link route="base/flex">flex</Link>,{" "}
                    <Link route="base/spacing">spacing</Link>, and{" "}
                    <Link route="base/typography">typography</Link> base
                    sections.
                  </p>
                  <br />
                  <h3
                  ...
                  <br />
                  <p>
                    Every component, abstract, utility, and base have variables
                    that you can use when creating your application. For more
                    info and examples, visit any abstract or component page or
                    see <Link route="base/elevation">elevation</Link>,{" "}
                  ...
                  <br />
                  <p>
                    To see all the variables available for each component, base,
                    or abstract, please refer to the{" "}
                    <b className="v-typography-body-2-bold">
                      tokens & variables
                    </b>{" "}
                  ...
                  <div className="v-flex v-flex-col v-gap-4">
                    <img
                      ...
                      src={browserVariablesPanel}
                      alt="Thumbnail of the tokens and variables panel"
                      className="v-mx-auto"
                      aria-describedby="browser-variables-panel-description"
                    />
                    <br />
                    <span
                      className="w-caption v-mx-auto"
                      id="browser-variables-panel-description"
                    >
                      Tokens and variables panel is shown on the right of the
                      component pages.
                    </span>
                  </div>
                  <br />
                  ...
                  <h2
                    className="v-typography-headline-2"
                    id="theming"
                    ref={getTocRef("theming")}
                  >
                    Theming
                  </h2>
                  <br />
                  <p>
                    Our theming approach is meant to tackle at least these two
                    scenarios:{" "}
                  </p>
                  <br />
                  <ol className="w-list">
                    <li>
                      small configuration with high impact (good for white
                      labeling)
                    </li>
                    <li>
                      specific overrides for custom approach (good for custom
                      look-and-feel)
                    </li>
                  </ol>
                  <br />
                  ...
                  <br />
                  <p>
                    The theming configuration allows you to modify a small set
                    of variables for maximum impact across components.
                  </p>
                  <CodeView
...
:root {\n\
  ...
  --theme-scale-factor: 1;\n\
                  ...
                  <table className="v-table v-table-key-value">
                    ...
                    <tbody>
                      <tr className="v-table-tr-alt">
                        <th scope="row" className="v-table-td">
                          <code className="w-code v-badge v-badge-subtle">
                            --theme-font-size
                          </code>
                        </th>
                        ...
                        <td className="v-table-td">
                          Base font size. Used to calculate <code>rem</code>{" "}
                          units and typography sizes.
                        </td>
                      </tr>
                      <tr className="v-table-tr-alt">
                        <th scope="row" className="v-table-td">
                      ...
                      <tr className="v-table-tr-alt">
                        ...
                        <td className="v-table-td">
                          Default border width on new components.
                        </td>
                      </tr>
                      <tr className="v-table-tr-alt">
                        <th scope="row" className="v-table-td">
                        ...
                        <td className="v-table-td">
                          Base focus outline width. Applies to all focus state
                          outlines.
                        </td>
                      </tr>
                      <tr className="v-table-tr-alt">
                        ...
                        <td className="v-table-td">
                          Base focus outline space between edge of component and
                          focus outline. Applies to all focus state outlines.
                        </td>
                      </tr>
                      <tr className="v-table-tr-alt">
                        <th scope="row" className="v-table-td">
                        ...
                        <td className="v-table-td">
                          Float to use as multiplier for all responsive and
                          scalable size variables on small screens.
                        </td>
                      </tr>
                      <tr className="v-table-tr-alt">
                        <th scope="row" className="v-table-td">
                        ...
                        <td className="v-table-td">
                          Float to use as multiplier for all scalable size
                  ...
                  <br />
                  <p>
                    The simplest way to customize the theme is by adjusting the
                    palette colors. The palette is a set of colors which are
                    associated to different parts across components. For
                    instance{" "}
                    <code className="w-code v-badge v-badge-subtle">
                      surface
                    </code>{" "}
                    ...
                    are consumed across components so they can be easily themed.
                  </p>
                  <br />
                  <p>
                    By default, different states are calculated based on the
                    given hue, lightness, and saturation provided. For instance,
                    the hover state for primary raises the given color's
                    lightness by 10%.
                  </p>
                  <br />
                  <p>
                    When defining the theme palette while leveraging HSL
                    automated state handling, you need to provide hue,
                    saturation, and lightness values for the following base
                    colors:{" "}
                  </p>
                  <br />
                  <table
                      ...
                      <tr className="v-table-tr-alt">
                        ...
                        <td className="v-table-td">
                          <div
                            ...
                            style={{
                              background:
                                "var(--palette-default-active-accent)",
                            }}
                          ></div>
                        </td>
                      </tr>
                      ...
                      <tr className="v-table-tr-alt">
                        ...
                        <td className="v-table-td">
                          <div
                            className="w-color-box"
                            style={{
                              background: "var(--palette-default-text)",
                            }}
                          ></div>
                        </td>
                      </tr>
                      <tr className="v-table-tr-alt">
                        ...
                        <td className="v-table-td">
                          <div
                            ...
                            style={{
                              background:
                                "var(--palette-messaging-graphics-positive)",
                            }}
                          ></div>
                        </td>
                      </tr>
                  ...
                  <br />
                  <p>
                    To see how these HSL palette color variables apply across
                    the design palette, see{" "}
                    <Link route="themes/default">
                      the Default theme Tokens & Variables page
                    </Link>
                    .
                  </p>
                  <br />
                  <p>
                    In the case of Nova, all the palette colors have been
                    specified directly, overriding the automated state handling
                    with HSL colors. To see a list of all the Nova palette
                    customized colors, see{" "}
                    <Link route="themes/nova">
                      the Nova theme Tokens & Variables page
                    </Link>
                    .
                  </p>
                  <br />
                  ...
                  <br />
                  <p>
                    All typography styles and classes define and override the
                    following base typography variables. You can customize or
                    override on any component or typography utility class.
                  </p>
                  <br />
                  <table
                  ...
                  <br />
                  <p>
                    To see all the typography classes and variables, please
                    visit the{" "}
                    <Link route="base/typography">
                  ...
                  <h3
                    className="v-typography-headline-3"
                    id="themer-app"
                    ref={getTocRef("themer app")}
                  >
                    Themer App
                  </h3>
                  <br />
                  <p>
                    Feel free to create, save, and export custom themes directly
                    on our&nbsp;
                    <Link
                  ...
                  <br />
                  <p>
                    Further customization is enabled via a combination of
                    approaches:
                  </p>
                  <br />
                  <ol className="w-list">
                    ...
                    <li>
                      leveraging utility classes to create custom component
                      variants
                    </li>
                    <li>
                      using available abstracts to create components with
                      smaller pieces
                    </li>
                  </ol>
                  <br />
                  ...
                  <br />
                  <p>
                    CSS variable overrides can be performed at different levels.
                    One could edit the theme or the component directly. In order
                    to change a button color at the theme level, one could
                    update the primary color HSL values:
                  </p>
                  <CodeView
  ...
  :root {\n\
    ...
    --color-primary-l: 67%;\n\
                  ...
                  />
                  <p>
                    Alternatively, in the case of Nova, one could update the
                    palette variables directly:
                  </p>
                  <CodeView
  ...
  :root {\n\
    ...
    --palette-default-active-pressed: #7528d8;\n\
                  ...
                  />
                  <p>
                    When overriding only one component or one instance of a
                    component without customizing the whole theme, one could
                    redefine the component variables directly:
                  </p>
                  <CodeView
...
'
                  ...
                  <h3
                    className="v-typography-headline-3"
                    id="variants"
                    ref={getTocRef("variants")}
                  >
                    Variants
                  </h3>
                  <br />
                  <p>
                    For some customization efforts, you may need to update the
                    markup structure or the display properties of the component.
                    We provide some examples of some variants that can help make
                    the component your own.
                  </p>
                  <br />
                  <p>
                  ...
                  <br />
                  <p>
                    Also, view utility classes available that can help you shape
                    your components with{" "}
                    <Link route="base/typography">typography</Link>,{" "}
                  ...
                  <br />
                  <p>
                    For some customization efforts, you may want to start with
                    some pre-wired basic elements to extend and create your own
                    component. Please see the abstracts provided to see more
                    examples.{" "}
                  </p>
                  <br />
                  <br />
                  <h3
                    className="v-typography-headline-3"
                    id="variables-or-utilities"
                    ref={getTocRef("variables-or-utilities")}
                  >
                    Overriding with CSS Variables or utility classes
                  </h3>
                  <br />
                  <p>
                    Some properties such as flex, spacing, elevation, and
                    typography can be overriden via css variables OR utilities
                  </p>
                  <CodeView
                    name=" Padding override"
                    markup={`<div class="v-flex v-gap-10">\n\
  ...
  <div class="v-surface v-py-20">20px vertical padding add via utility class</div>\n\
                  ...
                  <CodeView
                    ...
                    markup={`<div class="box" style="box-shadow: var(--elevation-xlarge);">Via variable</div>\n\
