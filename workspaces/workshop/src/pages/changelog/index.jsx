...
const Changelog = () => {
  ...
  useEffect(() => {
    ...
    mdRef.current.querySelectorAll("h1").forEach((element) => {
      element.className = "v-typography-headline-1";
    });
    mdRef.current.querySelectorAll("h2").forEach((element) => {
      element.className = "v-typography-headline-2 v-mt-20";
    });
    ...
    mdRef.current.querySelectorAll("h3").forEach((element) => {
      element.className = "v-typography-subtitle-1";
    });
    mdRef.current.querySelectorAll("li").forEach((element) => {
      element.className = "v-typography-body-1";
    });
